module.exports = function(sequelize, DataTypes) {
    ...
    var Point_On_Answer = sequelize.define('Point_On_Answer',
        {
            fromUserId: {
        ...
        },
        {
            classMethods: {
                associate: function(models) {
                    Point_On_Answer.belongsTo(models.User);
                    Point_On_Answer.belongsTo(models.Answer);
                }
            }
        });

    return Point_On_Answer;
};
